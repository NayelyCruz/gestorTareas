...
module.exports = {
    ...
    module: {
        rules: [
            {
                test: /\.css$/, //Regex para identificar arcivos CSS
    ...
    devServer: {
        contentBase: path.resolve(__dirname, 'dist'), // Carpera desde donde obtenemos los archivos que mostramos al usuario
